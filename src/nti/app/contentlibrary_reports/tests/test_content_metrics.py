...
class TestContentConsumptionTime(unittest.TestCase):
    ...
    def test_content_consumption_time(self):
        ...
        book_estimated_minutes_normalized = math.ceil(book_estimated_minutes / tparams['block_per_min']) * tparams['block_per_min']
        ...
        chapter1_estimated_minutes_normalized = math.ceil(chapter1_estimated_minutes / tparams['block_per_min']) * tparams['block_per_min']
        ...
        chapter2_estimated_minutes_normalized = math.ceil(chapter2_estimated_minutes / tparams['block_per_min']) * tparams['block_per_min']
